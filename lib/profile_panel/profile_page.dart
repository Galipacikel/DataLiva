          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () async {
                  Navigator.pop(context);
                  final picked = await ImagePicker().pickImage(source: ImageSource.camera, preferredCameraDevice: CameraDevice.front);
                  if (picked != null) {
                    setState(() {
                      _profileImage = File(picked.path);
                    });
...
class _ProfileCard extends StatelessWidget {
  ...
  final Color? color;
  const _ProfileCard({required this.icon, required this.label, required this.onTap, this.color});
