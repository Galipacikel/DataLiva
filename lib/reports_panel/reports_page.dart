...
class _ReportTab extends StatelessWidget {
  ...
  final Color color;
  const _ReportTab({required this.label, required this.selected, required this.onTap, required this.color});
            ...
            children: [
              ...
              Row(
                children: const [
                  ...
                  Text(' 10%', style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold)),
                ],
              ),
            ],
          ),
                ...
                return Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text(categories[i], style: const TextStyle(color: Colors.black54)),
                    ],
                  ),
                );
              }),
  ...
  Widget build(BuildContext context) {
    ...
    return _ReportCard(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Spending by Product', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          const SizedBox(height: 8),
          Row(
            crossAxisAlignment: CrossAxisAlignment.end,
            children: [
            ...
            return Padding(
              ...
              child: Row(
                children: [
                  SizedBox(
                    width: 90,
                    child: Text(products[i], style: const TextStyle(color: Colors.black54)),
                  ),
                  Expanded(
                    child: Stack(
                      children: [
                  ...
                  Text('4B2${values[i].toStringAsFixed(0)}', style: const TextStyle(fontWeight: FontWeight.bold)),
                ],
              ),
            );
          }),
